...
namespace ProjectName.Server
{
    internal static class HttpHandler
    {
        ...
        internal static async Coroutine<HttpResponseMessage> OnHttpResponseMessageAsync(HttpMethod httpMethod, string url, string endpoint = "", object data = null, Dictionary<string, string> cookies = null)
        {
        ...
        internal static async Coroutine<T> GetObjectFromResponseContentAsync<T>(this HttpResponseMessage httpResponseMessage)
        {
